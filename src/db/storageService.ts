...
export class StorageService {
  ...
  public setGroupData(groupData: GroupData): Thenable<void> {
    return this.setWorkspaceState(
      `group:data:${groupData.id}`,
  ...
  public async deleteTabItemByPath(
    groupId: string,
    fsPath: string,
  ): Promise<void> {
    const groupData = this.getGroupData(groupId);
